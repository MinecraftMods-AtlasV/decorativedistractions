...
public class TintBlock extends BaseEntityBlock {

    public TintBlock(BlockBehaviour.Properties props) {
        super(props);
    }

    @Override
    public MapCodec<TintBlock> codec() {
        return simpleCodec(TintBlock::new);
    }
